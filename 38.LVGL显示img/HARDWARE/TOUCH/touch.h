...
#define EVDEV_HOR_MIN       210               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
#define EVDEV_HOR_MAX      3700               /*"evtest" Linux tool can help to get the correct calibraion values>*/
#define EVDEV_VER_MIN       210
#define EVDEV_VER_MAX      3700
